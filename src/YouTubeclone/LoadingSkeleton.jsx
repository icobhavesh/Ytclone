...
const LoadingSkeleton = () => {
    return (
        <div className="grid  sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mt-4 w-full h-screen">
            <div className="relative p-4 w-full bg-whiteoverflow-hidden shadow hover:shadow-md rounded-lg">
